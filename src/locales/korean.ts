const English = {
  translation: {
    ...
    landing: {
      ...
      splashPage: {
        howBibimbapWorks: '비빔밥 파이낸스란?',
        treasuryRevenue: '금고 수익',
        bondsLPFees: '본드 & LP 수수료',
        bondSales:
          '본드 판매와 LP 수수료는 비빔밥 금고의 주요 수익이며 유동성은 고정됩니다. 이는 BBB 공급 조절에 기여합니다.',
        treasuryGrowth: '금고 확장',
        bibimbapTreasury: '비빔밥 금고',
        treasuryInflow:
          '금고로 유입되는 자금은 비빔밥 금고 잔액를 증가시킴으로써 BBB 토큰을 지지합니다. 이 자금은 예치 APY를 조절하는 요인입니다.',
        stakingRewards: '예치 보상',
        bbbToken: 'BBB 토큰',
        compounds:
          '예치 보상은 프로토콜에 참여함으로써 받는 보상의 방법입니다. (비빔, 비빔) 행렬은 예치자들의 이익을 최대화하기 위해 설계되었습니다.',
        treasuryBalance: '금고 잔액',
        totalStaked: '총 예치 양',
      },
    },
    // src\views\Stake
