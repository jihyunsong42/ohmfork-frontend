...
function TreasuryDashboard() {
  ...
  return (
    <div id="treasury-dashboard-view" className={`${smallerScreen && 'smaller'} ${verySmallScreen && 'very-small'}`}>
      ...
      {/* <div>
        <Box component="div" style={{ textAlign: 'center' }} color="text.primary">
          <img src={Bibim} width="200px" />
          <h1>Stake your Bibimbap and monetize it.</h1>
          <p>For long time, Joseon people enjoyed Bibimbap as their soul food, regardless of their class.</p>
          <p>Bibimbap is also symbol of Jeonju, the place where Joseon King's Family originally came from.</p>
          <p>We believe the financial system should be accessible to everyone like Bibimbap.</p>
          <h3>Stake Your Bibimbap(BBB) into protocol-owned Treasury.</h3>
          <h3>Buy Bibimbap at cheaper price by bonding your assets from our protocol.</h3>
          <h2>We're All Gonna Make It.</h2>
        </Box>
      </div> */}
      <div className="wave" />
      <Container
          ...
          <Paper className="ohm-card">
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              {displayData.map(({ title, value, info }, i) => (
                <Box key={i} border={5} borderColor="#C74B26" className="metric">
