...
export const tooltipInfoMessages = {
  tvl: 'Total Value Deposited, is the dollar amount of all BBB staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.',
  mvt: 'Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.',
  rfv: 'Risk Free Value, is the amount of funds the treasury guarantees to use for backing BBB.',
  ...
  holder: 'Holders, represents the total number of otters (sBBB holders)',
  staked: 'BBB Staked, is the ratio of sBBB to BBB (staked vs unstaked)',
  ...
  runway: 'Runway, is the number of days sBBB emissions can be sustained at a given rate. Lower APY = longer runway',
  currentIndex:
    'The current index tracks the amount of sBBB accumulated since the beginning of staking. Basically, how much sBBB one would have if they staked and held a single BBB from day 1.',
};
